...
A larger size increases the model’s capacity to learn complex, non-linear relationships, but also raises the risk of overfitting and increases computational complexity.
...
Random Forest (≈ 842k) < Linear Regression (≈ 1,019k) < Neural Network (≈ 1,101k).
