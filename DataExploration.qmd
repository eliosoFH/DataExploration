...
subtitle: "Dataset: Startup Investments (https://www.kaggle.com/datasets/justinas/startup-investments)"
author: "Hamulic, Gabriel"
date: today
embed-resources: true
format:
  html: 
    output-file: start-up-investments_Gabriel_Hamulic.html
    ...
    #echo: fenced
  pdf: 
    output-file: start-up-investments_Gabriel_Hamulic.pdf 
    toc: true
...
-   In the YAML fields `output:` for HTML and PDF insert the correct name for the output files (`name-of-datasetyour-surnameyour-first-name`) including correct extensions `.html` `.pdf`.
...
```{r} data = read.csv("data/archive/realtor-data.zip.csv")  data}
```
